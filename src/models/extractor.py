...
class LandRegistrationAct(BaseModel):
    ...
    land_holder_names: str = Field(..., description="extract comma separated land holder names or name from the information and do not include(ID number) and (deceased) information.")
