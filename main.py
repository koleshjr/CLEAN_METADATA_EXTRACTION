...
if __name__ == "__main__":
    ...
    if args.task_type == 'classification':
        ...
        final_sub_path = os.path.join(Config.output_folder, f'experiment_{args.experiment}')
        transform_submission(predicted_sub=classified_pdf, sample_sub=Config.sample_sub_filepath,output_file_path= final_sub_path)
